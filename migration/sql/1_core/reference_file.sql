INSERT INTO maurodatamapper.core.reference_file(id, version, file_size, date_created, last_updated, catalogue_item_domain_type, file_type, file_name,
                                                file_contents, catalogue_item_id, created_by)
SELECT cf.id,
       cf.version,
       cf.file_size,
       cf.date_created,
