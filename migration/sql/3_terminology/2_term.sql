...
SELECT t.id   AS term_id,
       ...
       NULL   AS metadata_id
FROM maurodatamapper.terminology.term t
     INNER JOIN maurodatamapper.core.annotation ann ON ann.catalogue_item_id = t.id AND ann.catalogue_item_domain_type = 'Term';
...
SELECT t.id  AS term_id,
       ...
       NULL  AS metadata_id
FROM maurodatamapper.terminology.term t
     INNER JOIN maurodatamapper.core.semantic_link sl ON sl.catalogue_item_id = t.id AND sl.catalogue_item_domain_type = 'Term';
...
SELECT t.id  AS term_id,
       ...
       NULL  AS metadata_id
FROM maurodatamapper.terminology.term t
     INNER JOIN maurodatamapper.core.reference_file rf ON rf.catalogue_item_id = t.id AND rf.catalogue_item_domain_type = 'Term';
...
FROM maurodatamapper.terminology.term t
     INNER JOIN maurodatamapper.core.metadata md ON md.catalogue_item_id = t.id AND md.catalogue_item_domain_type = 'Term';
